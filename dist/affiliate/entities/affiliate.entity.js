...
exports.AffiliateSchema = exports.Affiliate = void 0;
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
let Affiliate = class Affiliate extends mongoose_2.Document {
};
...
__decorate([
    ...
    __metadata("design:type", String)
], Affiliate.prototype, "email", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true, unique: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)({ type: [{ type: mongoose_2.Types.ObjectId, ref: 'Referral' }] }),
    __metadata("design:type", Array)
], Affiliate.prototype, "referrals", void 0);
exports.Affiliate = Affiliate = __decorate([
    (0, mongoose_1.Schema)()
], Affiliate);
exports.AffiliateSchema = mongoose_1.SchemaFactory.createForClass(Affiliate);
